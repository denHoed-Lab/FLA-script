---
title: "PeakScanner_peakFilter_V3_5_1: 20220404_MDH_kita-T1_mpompeg_PLATE01"
author: 'Kita-T1-atto --- excluded 183, 210'
script version: "v3_5"
...
IgnorePeakSize <- c(183, 210) # set to -1000 if nothing should be ignored, as there will not be any peaks with size -1000.
...
write.table(peakScanner_DF_S, paste0(dir_output, str_replace(fileName,".txt",""),"_RESULTS_T1_atto.txt"), row.names=FALSE, quote = FALSE, append = FALSE, sep = "\t")
print("--------------")
print(paste("Saved output as file ", paste0(str_replace(fileName,".txt",""),"_RESULTS_T1_atto.txt")))
print(paste("@",paste0(getwd(),str_replace(dir_output,"./","/"))))

write.table(peakScanner_DF_F, paste0(dir_output, str_replace(fileName,".txt",""),"_peakScanner_DF_F_DATA-FRAME_T1_atto.txt"), row.names=FALSE, quote = FALSE, append = FALSE, sep = "\t")
...
#setting up the file name and output directory to save the knitted file
 outputFileName <- paste0(str_replace(fileName,".txt",""), "_FLA_OVERVIEW_T1_atto")
...
viewerpane.html(xfile = paste0(outputPath,outputFileName,"_T1_atto",".html"))
}
```
